...
export const CategoryPagination = ({
  ...
  const MAX_ITEMS = maxPagesVisible ?? 5
  ...
  return (
    <div className={handles.containerProducts}>
      <ul className={handles.pagination}>
        ...
        <li className={handles.backToFirstContainer}>
          <a
            href={changePage(page - page + 1)}
            className={`${handles.backToFirst} ${
              page === 1 && handles.buttonDisabled
            }`}
          >Primeiro</a>
        </li>
        ...
        <li className={handles.nextToLastContainer}>
          <a
            href={changePage(pages)}
            className={`${handles.nextToLast} ${
